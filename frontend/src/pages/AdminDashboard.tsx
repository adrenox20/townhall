  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        ...
        <Kpi icon={<AlertTriangle size={20} />} label="Awaiting Review" value={data.totals.awaiting_review ?? 0} color="red" />
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="panel p-5">
          <h2 className="text-sm font-semibold text-white mb-4">Submission Volume</h2>
          <div className="h-64">
            <ResponsiveContainer>
      ...
      <section className="space-y-4">
        ...
        {data.attention.length ? data.attention.map((issue) => <IssueCard key={issue.id} issue={issue} />) : (
